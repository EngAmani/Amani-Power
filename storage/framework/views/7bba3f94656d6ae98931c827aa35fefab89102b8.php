...
<p style="font-weight: bold;  font-size: large;text-align:center;color:#000000;margin-top:-28px; float:center">بيان الحضور و الانصراف لشهر <?php echo e($monthAr); ?></p>
<p style="text-align:left;color:#000000; margin-top:-8px;opacity: 0.8;float:left">

الموظفة:<?php echo e($userinfo->name); ?>  
...
if($workinHoure>=7){
 ...
 ?>
    ...
    <td style="text-align:center;line-height: 14px;"><?php echo e($post->date); ?></td>


    <td style="text-align:center;line-height: 14px;"><?php echo e($attendOreginal); ?></td>
    <td style="text-align:center;line-height: 14px;"><?php echo e($leaveOreginal); ?></td>
    <style>
     .late{
    ...
    <td  <?php if($hours != 0 || $min != 0): ?> ? class="late" : class="onTime" <?php endif; ?> style="text-align:center;line-height: 14px;"><?php echo e($hours); ?> ساعة و<?php echo e($min); ?> دقائق </td>
...
$total_vacc=$a+$ab+$b+$c;
?>
    <td><?php echo e($total_vacc); ?></td>
    <td><?php echo e($userinfo->calcVaccationPDF($month,$userinfo->id)); ?></td>
    <td><?php echo e($userinfo->etraryCalc($userinfo->id,true)); ?></td>
    <td><?php echo e($userinfo->calcSickLeavePDF($month,$userinfo->id)); ?></td>
    <td><?php echo e($userinfo->calcDeathLeavePDF($month,$userinfo->id)); ?></td>
    <td><?php echo e($userinfo->absentCalculator($userinfo->id,$month)); ?></td>
    <td><?php echo e($userinfo->excusesHours($userinfo->id,$month,1)); ?></td>
    <td><?php echo e($userinfo->excusesHours($userinfo->id,$month,0)); ?></td>
    <td><?php echo e($userinfo->calc($userinfo->id,$month,false,1)); ?></td>
    <td><?php echo e($userinfo->calc($userinfo->id,$month,false,0)); ?></td>
  </tr>
...
<!-- 
<h4>مجموع دقائق الإستئذان: <?php echo e($userinfo->calc($userinfo->id,$month)); ?></h4>

<h4>مجموع دقائق التأخير:<?php echo e($userinfo->calc()); ?></h4> -->

<style> 
 * { font-family: Arial,DejaVu Sans, sans-serif; }
</style><?php /**PATH C:\XAMPP\htdocs\hrSystem\resources\views/pdf/index.blade.php ENDPATH**/ ?>